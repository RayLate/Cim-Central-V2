...
class DeviceModel(models.Model):
    ...
    deviceType = models.ForeignKey(
        DeviceType, on_delete=models.CASCADE, null=False, default="testing"
    )
...
class Device(models.Model):
    ...
    ownership = models.CharField(
        max_length=20, choices=ownership_choices, default="Primary Device"
    )

    serialnumber = models.CharField(max_length=15, unique=True, null=False)
    deviceOwner = models.CharField(max_length=10, null=False)
    submittor = models.ForeignKey("auth.User", on_delete=models.CASCADE)
